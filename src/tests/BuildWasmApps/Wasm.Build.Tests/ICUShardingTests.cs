...
namespace Wasm.Build.Tests
{
    public class ICUShardingTests : BuildTestBase
    {
        ...
        [MemberData(nameof(ICUShardingTestData_EFIGS), parameters: new object[] { false, RunHost.V8 })]
        ...
        public void ShardingTests(BuildArgs buildArgs, bool? invariantGlobalization, string defaultCulture, string testCulture, bool expectToThrow, RunHost host, string id)
            => TestICUSharding(buildArgs, invariantGlobalization, defaultCulture, testCulture, expectToThrow, host, id);
                            ...
                            bool? dotnetWasmFromRuntimePack=null)
        {
            ...
            string extraProperties = $"<EnableSharding>true</EnableSharding><ICUDefaultCulture>{defaultCulture}</ICUDefaultCulture>";
            ...
            buildArgs = ExpandBuildArgs(buildArgs, extraProperties: $"<EnableSharding>true</EnableSharding><ICUDefaultCulture>{defaultCulture}</ICUDefaultCulture>");
