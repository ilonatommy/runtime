...
{
    public class CompareInfoIndexOfTestsData
    {
        ...
        public static IEnumerable<object[]> IndexOf_U_WithDiaeresis_TestData()
        {
            ...
            yield return new object[] { s_invariantCompare, source, "U\u0308", 8, 18, CompareOptions.None, 24, 1 }; //failed
        ...
        public static void IndexOf_Char(CompareInfo compareInfo, string source, char value, int startIndex, int count, CompareOptions options, int expected)
        {
