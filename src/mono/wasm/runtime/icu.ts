...
// @path is the path to directory in VFS
// returns true on success.
export function mono_wasm_set_icu_dir(path: string): boolean {
    icu_assets_loaded_successfully = (cwraps.mono_wasm_set_icu_dir(path)) === 1;
