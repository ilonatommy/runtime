...
import {
    ...
    mono_wasm_get_by_index_ref, mono_wasm_set_by_index_ref, mono_wasm_get_global_object_ref, mono_wasm_get_browser_cultures, mono_wasm_normalize_string,
    mono_wasm_is_string_normalized, mono_wasm_change_case,
