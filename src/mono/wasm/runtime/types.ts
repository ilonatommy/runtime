...
export type MonoConfig = {
    ...
    application_culture: string; // Current browser culture
    enable_sharding: boolean,
    default_culture: string,
    icu_dictionary: IcuDictionary; // Structure of icu_dictionary.json generated by icu.mk in ICU
...
export type IcuDictionary = {
    packs: { [key: string]: any },
